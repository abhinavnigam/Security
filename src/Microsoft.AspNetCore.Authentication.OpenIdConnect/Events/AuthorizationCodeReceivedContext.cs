...
namespace Microsoft.AspNetCore.Authentication.OpenIdConnect
{
    ...
    public class AuthorizationCodeReceivedContext : BaseOpenIdConnectContext
    {
        ...
        /// same as calling SkipCodeRedemption. If set then the middleware will not attempt to redeem the code. An IdToken
        ...
        /// </summary>
        public void SkipCodeRedemption()
        {
        ...
        /// user-info endpoint. Calling this is the same as setting TokenEndpointResponse.
        /// </summary>
        public void SkipCodeRedemption(string accessToken)
        {
        ...
        /// user-info endpoint. Calling this is the same as setting TokenEndpointResponse.
        /// </summary>
        public void SkipCodeRedemption(OpenIdConnectMessage tokenEndpointResponse)
        {
